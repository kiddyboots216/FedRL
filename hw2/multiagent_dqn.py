...
parser.add_argument("--num-iters", '-iters', type=int, default=20)
...
if __name__ == "__main__":
    ...
    IndepMultiAgentEnv = make_multiagent(args.env)
    multienv_name = "multi_{}".format(args.env)

    register_env(multienv_name, lambda _: IndepMultiAgentEnv(1))
    ...
    exp_name = "{}_{}_{}_{}_{}_{}_{}_{}_{}".format(
        args.name,
        args.env,
        args.num_agents,
        args.num_iters,
