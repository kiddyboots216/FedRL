#!/usr/bin/env python
"""
Example of how to train an RL model (in this case deep-Q)
with distributed SGD.
This is a fairly complex model, so we expect to see some
speedup.
"""
...
class DQNModel(Agent, Model):
    ...
    def __init__(self):
        ...
        # TODO: Expose self.loss for dist_sgd interface
    ...
    def get_feed_dict(self):
        ...
        """
        result = self._train()
        # TODO: Make feed_dict out of result for dist_sgd interface
        return result
...
if __name__ == "__main__":
    ...
    if args.tune:
        ...
        train_dqn({"args": args}, lambda **kw: None)
